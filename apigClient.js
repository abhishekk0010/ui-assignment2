...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://61xp9plwfe.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.imageObjectGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }

        apiGateway.core.utils.assertParametersDefined(params, ['object'], ['body']);

        var imageObjectGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/image/{object}').expand(apiGateway.core.utils.parseParametersToObject(params, ['object'])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(imageObjectGetRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'Content-Type'], ['body']);
    ...
    apigClient.getImage = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        ...
        var uploadOptionsRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/image/{object}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
